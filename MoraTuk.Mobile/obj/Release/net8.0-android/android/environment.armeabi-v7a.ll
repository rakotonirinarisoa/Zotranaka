...
@dso_cache = dso_local local_unnamed_addr global [630 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 25418048, ; hash 0x183d940, from name: libaot-MoraTuk.Mobile
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1085155683, ; hash 0x40ae2963, from name: libaot-MoraTuk.Mobile.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MoraTuk.Mobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 155
	...
	%struct.DSOCacheEntry {
		i64 1695626824, ; hash 0x65113648, from name: MoraTuk.Mobile.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MoraTuk.Mobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 232
	...
	%struct.DSOCacheEntry {
		i64 2988600919, ; hash 0xb2226e57, from name: MoraTuk.Mobile
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MoraTuk.Mobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 445
	...
	%struct.DSOCacheEntry {
		i64 3106739312, ; hash 0xb92d1470, from name: aot-MoraTuk.Mobile
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MoraTuk.Mobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 467
	...
	%struct.DSOCacheEntry {
		i64 3346005142, ; hash 0xc76ffc96, from name: aot-MoraTuk.Mobile.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MoraTuk.Mobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 495
